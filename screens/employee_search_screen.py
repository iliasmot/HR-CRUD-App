...
class EmployeeSearchScreen(tk.Frame):
    """ Screen for searching in the employee database, ment to be used by general users."""
    def __init__(self, parent, controller):
        super().__init__(parent)
        self.controller = controller
        self.crud = CRUD(self, self.controller)
        self.currentCRUDAction = None
        self.columns = ["last_name", "first_name", "email", "phone", "business_mobile", "department", "building", "floor"]
        self.columnNames = ["Επώνυμο", "Όνομα", "Email", "Εσωτερικό", "Υπηρεσιακό Κινητό", "Τμήμα", "Κτήριο", "Όροφος"]

        self.crud.create_header("LogInScreen", "Προσωπικό", "👥") #🚹
